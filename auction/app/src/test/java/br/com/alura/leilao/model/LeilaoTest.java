...
public class LeilaoTest {
    ...
    public void deve_DevolveMaiorLance_QuandoRecebeMaisDeUmLanceEmOrdemCrescente() {
        ...
        CONSOLE.propoe(new Lance(new Usuario("Winky"), 200.0));
    ...
    public void deve_DevolverTresMaioresLances_QuandoRecebeExatosTresLances() {
        CONSOLE.propoe(new Lance(MARCOS, 200.0));
        CONSOLE.propoe(new Lance(new Usuario("Winky"), 300.0));
        ...
        assertThat(tresMaioresLancesDevolvidos,
                both(Matchers.<Lance>hasSize(3))
                        .and(contains(
                                ...
                                new Lance(new Usuario("Winky"), 300.0),
    ...
    public void deve_DevolverTresMaioresLances_QuandoRecebeApenasDoisLances() {
        ...
        CONSOLE.propoe(new Lance(new Usuario("Winky"), 400.0));
    ...
    public void deve_DevolverTresMaioresLances_QuandoRecebeMaisDeTresLances() {
        CONSOLE.propoe(new Lance(MARCOS, 300.0));
        final Usuario WINKY = new Usuario("Winky");
        CONSOLE.propoe(new Lance(WINKY, 400.0));
        CONSOLE.propoe(new Lance(MARCOS, 500.0));
        CONSOLE.propoe(new Lance(WINKY, 600.0));
    ...
    @Test(expected = MaximoCincoLancesPorUserException.class)
    public void naoDeve_AdicionarLance_QuandoUsuarioDerCincoLances() {
        CONSOLE.propoe(new Lance(MARCOS, 100.0));
        final Usuario WINKY = new Usuario("Winky");
        CONSOLE.propoe(new Lance(WINKY, 200.0));
        CONSOLE.propoe(new Lance(MARCOS, 300.0));
        CONSOLE.propoe(new Lance(WINKY, 400.0));
        CONSOLE.propoe(new Lance(MARCOS, 500.0));
        CONSOLE.propoe(new Lance(WINKY, 600.0));
        CONSOLE.propoe(new Lance(MARCOS, 700.0));
        CONSOLE.propoe(new Lance(WINKY, 800.0));
        CONSOLE.propoe(new Lance(MARCOS, 900.0));
        CONSOLE.propoe(new Lance(WINKY, 1000.0));
        CONSOLE.propoe(new Lance(MARCOS, 1100.0));
    }
